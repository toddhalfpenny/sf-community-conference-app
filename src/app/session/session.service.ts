...
export class SessionService {
  ...
  private _agenada = new Subject<Session[][]>();
  private sessionSubscription?: Subscription;

  public agenda$ = this._agenada.asObservable();
  ...
  async getSessions(options: {forceRefresh?: boolean, allStatuses?: boolean} = {}): Promise<Session[]> {
    ...
    // Set agenda based on cached sessions first to ensure UI is responsive, then update if needed
  ...
  private setAgenda(sessions: Session[]) {
